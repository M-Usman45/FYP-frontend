...
<div className="card">
<h1 className="centerText">Assets</h1>
<Chart type="polarArea"data={this.state.polarData}height="150"/>
</div>
</div>
<div className="p-col-12 p-lg-6">
<div className="card">
<h1 className="centerText">Assigned Assets</h1>
<Chart type="bar"data={this.state.barData}/>
</div>

<div className="card">
<h1 className="centerText">Approved Complains</h1>
<Chart type="doughnut"data={this.state.pieData}height="150"/>
</div>

<div className="card">
<h1 className="centerText">Organization's users</h1>
